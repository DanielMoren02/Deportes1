...
<body>
    ...
    <center>
        <div class="form-container">
            ...
            <form class="form">
              <input type="text" style="color: black" class="input" placeholder="Nombre">
              <input type="email" style="color: black" class="input" placeholder="Email">
              <input type="password" style="color: black" class="input" placeholder="Password">
