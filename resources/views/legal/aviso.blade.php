            ...
            <div class="container px-5">
                <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                    <div class="text-center mb-5">
                        ...
                        <strong><h3>AVISO DE PRIVACIDAD INTEGRAL<h3></strong>
                                            <br>TIENDA DEPORTIVA SPORTS SIGLO XXI mejor conocido como
                                                    SPORTSIGLOXXI.com, con domicilio en Segunda Poniente Sur, 232,
                                                    Guadalupe, Ocosingo, Chiapas, México y portal de internet
                                                    www.SPORTSIGLOXXI.com, es el responsable del uso y protección de sus
                                                    ...
                                                    <br>
                                                    <br>
                                                    Datos de identificación y contacto, Datos sobre pasatiempos
                                                    Información de pago o tarjeta de crédito, Datos sobre las características físicas,
                                                    incluyendo el peso, la estatura y las medidas corporales (tales como la zancada
                                                    estimada y las medidas del zapato/pie)
                                                    <br>
                                                    <br>
                                                    <br>
                                                    ...
                                                    qué los utilizamos y las condiciones del uso que les damos (Acceso). Asimismo,
                                                    ...
                                                    vía correo electrónico a SPORTSIGLOXXI@gmail.com y deberá contener:
                                                    <br>
                                                    <br>
                                                    ...
                                                    Descripción el objeto del escrito, los cuales pueden ser de manera enunciativa
                                                    más no limitativa los siguientes: Revocación del consentimiento para tratar sus
                                                    datos personales; y/o Notificación del uso indebido del tratamiento de sus datos
                                                    personales; y/o Ejercitar sus Derechos ARCO, con una descripción clara y
                                                    precisa de los datos a Acceder, Rectificar, Cancelar o bien, Oponerse. En caso
                                                    de Rectificación de datos personales, deberá indicar la modificación exacta y
                                                    anexar la documentación soporte; es importante en caso de revocación del
                                                    consentimiento, que tenga en cuenta que no en todos los casos podremos
                                                    atender su solicitud o concluir el uso de forma inmediata, ya que es posible que
                                                    por alguna obligación legal requiramos seguir tratando sus datos personales.
                                                    ...
                                                    comportamiento como usuario de internet, así como brindarle un mejor servicio y
                                                    experiencia al navegar en nuestra página. Los datos personales que obtenemos
                                                    de estas tecnologías de rastreo son los siguientes:
                                                    <br>
                                                    <br>
                                                    Identificadores, nombre de usuario y contraseñas de sesión, Idioma preferido por
                                                    el usuario, Región en la que se encuentra el usuario, Fecha y hora del inicio y
                                                    final de una sesión de un usuario, Publicidad revisada por un usuario.
                                                    <br>
                                                    <br>
                                                    ...
                                                    cuenta que, en caso de desactivar las cookies, es posible que no pueda acceder
                                                    ...
                                                    causas. Nos comprometemos a mantener actualizado este aviso de privacidad
                                                    sobre los cambios que pueda sufrir y siempre podrá consultar las
                                                    actualizaciones que existan en el sitio web www.SPORTSIGLOXXI.com
                                                    <br>
                                                    <br>
                                                    Última actualización de este aviso de privacidad: 21/09/2023</p>
